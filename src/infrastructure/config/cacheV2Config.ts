import { parseBooleanEnv } from "./envParsers";
...
export function resolveCacheV2Config(): CacheV2Config {
  return {
    analysisReplayEnabled: parseBooleanEnv("ANALYSIS_REPLAY_ENABLED", false),
    writeEnabled: parseBooleanEnv("CACHE_V2_WRITE_ENABLED", false),
    readTechTrailEnabled: parseBooleanEnv("CACHE_V2_READ_TECHTRAIL_ENABLED", false),
    readImeiEnabled: parseBooleanEnv("CACHE_V2_READ_IMEI_ENABLED", false),
    decisionCacheV1ReadEnabled: parseBooleanEnv("DECISION_CACHE_V1_READ_ENABLED", true),
    techTrailTtlDays: optionalPositiveInt("TECHTRAIL_CACHE_TTL_DAYS") ?? 30,
    imeiTtlDays: optionalPositiveInt("IMEI_CACHE_TTL_DAYS") ?? 30,
    replayTtlDays: optionalPositiveInt("ANALYSIS_REPLAY_TTL_DAYS") ?? 30,
  };
}
